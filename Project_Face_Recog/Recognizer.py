...
class recognize:
    def __init__(self,window):
        ...
        # Bg image
        bg=Image.open("Images/Recognize/bg.png")
        ...
        #heading
        heading=Label(self.window,text="Face Recognition",font=("times new roman",40,"bold"),bg="white",fg="darkgreen").place(x=500,y=5)
        ...
        # training btn
        btn_img1=Image.open("Images/Recognize/img.jpg")
        btn_img1=btn_img1.resize((250,300),Image.ANTIALIAS)
        self.btn_img1=ImageTk.PhotoImage(btn_img1)
        b1=Button(self.window,image=self.btn_img1,command=self.face_recognitn,cursor="hand2").place(x=790,y=90,width=250,height=300)
        b1_1=Button(self.window,text="Recognize Face",command=self.face_recognitn,cursor="hand2",font=("times new roman",15,"bold"),bg='green',fg="white").place(x=790,y=390,width=250,height=40)
