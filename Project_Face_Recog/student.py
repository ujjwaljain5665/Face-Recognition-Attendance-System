...
class student:
    def __init__(self,window):
        ...
        imglbl=Label(self.f1,image=self.img).place(x=90,y=0,width=300,height=200)
        # top frame -> Heading
        ...
        bck=Button(self.f1,image=self.bckimg,cursor="hand2",command=self.windexit).place(x=20,y=50,width=50,height=50)
