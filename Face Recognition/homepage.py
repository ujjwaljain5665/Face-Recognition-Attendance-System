...
class face_recognition:
    def __init__(self,window):
        ...
        b1=Button(self.window,image=self.btn_img2,cursor="hand2").place(x=240,y=350,width=160,height=120)
        b1_1=Button(self.window,text="Face Detector",cursor="hand2",font=("times new roman",15,"bold"),fg="red").place(x=240,y=470,width=160,height=40)
        ...
        b1=Button(self.window,image=self.btn_img3,cursor="hand2").place(x=450,y=350,width=160,height=120)
        b1_1=Button(self.window,text="Attendance",cursor="hand2",font=("times new roman",15,"bold"),fg="red").place(x=450,y=470,width=160,height=40)
        ...
        b1=Button(self.window,image=self.btn_img4,cursor="hand2").place(x=660,y=350,width=160,height=120)
        b1_1=Button(self.window,text="Train Data",cursor="hand2",font=("times new roman",15,"bold"),fg="red").place(x=660,y=470,width=160,height=40)
        ...
        b1=Button(self.window,image=self.btn_img5,cursor="hand2").place(x=870,y=350,width=160,height=120)
        b1_1=Button(self.window,text="Photos",cursor="hand2",font=("times new roman",15,"bold"),fg="red").place(x=870,y=470,width=160,height=40)
        ...
        b1=Button(self.window,image=self.btn_img6,command=exit,cursor="hand2").place(x=1080,y=350,width=160,height=120)
        b1_1=Button(self.window,text="Exit",command=exit,cursor="hand2",font=("times new roman",15,"bold"),fg="red").place(x=1080,y=470,width=160,height=40)
